...
for inix=1:8:256-7
    for iniy=1:8:256-7
        ...
        if entra == 1
            ...
            %image2(inix:inix+7,iniy:iniy+7) = idct2(Auxi);
            %image3(inix:inix+7,iniy:iniy+7) = ((image(posxmin:(posxmin+7),posymin:(posymin+7)))-(image2(inix:inix+7,iniy:iniy+7)));
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            %image3(inix:inix+7,iniy:iniy+7) = idct2(Auxi);
            %image3(inix:inix+7,iniy:iniy+7) = ((image(posxmin:(posxmin+7),posymin:(posymin+7)))-(image3(inix:inix+7,iniy:iniy+7)));
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for inix=1:8:256-7
    for iniy=1:8:256-7
        nun = nun +1;
        if matrix(nun,1) ~= 999
            %imagedecod(inix:inix+7,iniy:iniy+7) = ((imagedecod(matrix(nun,1):(matrix(nun,1)+7),matrix(nun,2):(matrix(nun,2)+7)))-(image3(matrix(nun,1):matrix(nun,1)+7,matrix(nun,2):matrix(nun,2)+7)));
